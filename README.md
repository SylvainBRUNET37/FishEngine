...
1 - Suivre les instructions pour générer la solution Jolt (lancer le bon .bat dans "Jolt\Build") https://github.com/jrouwe/JoltPhysics/blob/master/Build/README.md
...
3 - Dans le dossier 'assimp'
		...
		Build en release: cmake --build build --config Release
		Build en debug  : cmake --build build --config Debug
